...
public class DetailsController {
    @Autowired
    private DetailsDao detailsRepository;
    @Autowired
    ...
    public String addDetails(@RequestBody Detail details) {
        detailsRepository.save(new Detail(details.type, details.title, details.des, details.iconUrl, details.imgUrl, details.vendor ,details.date));
        return "success";
    }
